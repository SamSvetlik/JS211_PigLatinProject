...
const returnPigLatin = () => {
  let normal = document.getElementById('user-input').value;
  let converted = pigLatin(normal);
  document.getElementById("translation").innerText = converted
}
